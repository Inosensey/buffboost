...
type Fa7SolidHatWizardProps = SVGProps<SVGSVGElement> & {
  color: string;
  width?: string;
  height?: string;
};

export function Fa7SolidHatWizard(props: Fa7SolidHatWizardProps) {
  return (
    <svg
